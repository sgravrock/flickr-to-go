...
class AuthConsoleUi:
  ...
  def prompt_for_code(self, url):
    if self.subprocess.call(['open', url]) == 0:
      self.stdout.write('The Flickr login page should have opened in ' +
        'your browser. Please log in.\n')
    else:
      self.stdout.write("Open this in your browser: %s\n" % url)

    self.stdout.write("After you've finished logging in, enter the code " +
      'from your browser: \n'),
